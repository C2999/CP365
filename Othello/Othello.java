    ...
    public void paintComponent(Graphics g) {
        ...
        for (int r = 0; r < ob.size; r++) {
            for (int c = 0; c < ob.size; c++) {
                // square
                g.setColor(new Color(200, 200, 232));
...
class OthelloBoard implements Cloneable {
    ...
    @Override
    public OthelloBoard clone() throws CloneNotSupportedException 
    {
        OthelloBoard bClone = (OthelloBoard)super.clone();
        return bClone;
    }
...
class OthelloGame {
    ...
    public static int playGame(int boardSize, OthelloPlayer whitePlayer, OthelloPlayer blackPlayer, boolean viewPlayback, int playbackDelay) {
        int moves = 0;
